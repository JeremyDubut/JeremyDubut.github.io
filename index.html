...
<head>
	...
	<meta name="description" content="Jérémy Dubut's personal research webpage">
	<meta name="keywords" content="Jeremy Dubut, Jérémy Dubut, computer science, mathematics, research">
	<meta name="author" content="Jérémy Dubut">
	...
	<title>Jérémy Dubut's webpage</title>
	<!-- <script src="scripts/sidemenu.js"></script> -->
</head>
<body>
	<!-- <button class="sidemenu" id="sideMenu" onclick="openMenu()">
		&#9776;
	</button>
	<div class="contentSidemenu" id="sideMenuContent" onclick="closeMenu()">
		<p>
			<ul>
				<a href"">&rsaquo; Home<br></a>
				<a href"">&rsaquo; Publications<br></a>
				<a href"">&rsaquo; Teachings<br></a>
			</ul>
		</p>
	</div> -->
	<header class="chapo" id="header">
			<h1> Jérémy Dubut-Kross<br>(デュブ黒須・ジェレミー)</h1>
		<nav class="chapoMenu">
			<ul class="chapoMenuList">
				<li class="chapoMenuItem"><a href="#">Home</a></li>
				<li class="chapoMenuItem"><a href="#publis">Publications</a></li>
				<li class="chapoMenuItem"><a href="#talks">Talks</a></li>
				<li class="chapoMenuItem"><a href="#teachings">Teachings</a></li>
			</ul>
		</nav>
	</header>
	<h2>General information</h2>
		<p>I am a researcher in the <a href="https://www.cpsec.aist.go.jp/team/ipsrt/index_en.html">Infrastructure Protection Security Research Team</a>
			at the <a href="https://www.cpsec.aist.go.jp/index_en.html">Cyber Physical Security Research Center</a>
			of the <a href="https://www.aist.go.jp/index_en.html">National Institute of Advanced Industrial Science and Technology</a>,
			in Tokyo.</p>
		<p>I am also involved with the <a href="https://jfli.cnrs.fr">Japanese-French Laboratory for Informatics</a>.</p>
		<p>Previously, I was a Project Researcher (postdoc) and then a Project Assistant Professor in 
			<a href="http://group-mmm.org/~ichiro/">Prof. Ichiro Hasuo</a>'s 
			<a href="https://group-mmm.org/eratommsd/">ERATO Metamathematics for Systems Design Project</a> 
			at the <a href="http://www.nii.ac.jp/en/">National Institute of Informatics</a> in Tokyo.
			I am still involved in the project as a Visiting Researcher.</p>
		<p>Before that, I was a PhD student at <a href="http://www.lsv.fr/?l=en">LSV</a>, 
			<a href="http://ens-paris-saclay.fr/en">ENS Paris-Saclay</a>, under the supervision of 
			<a href="http://www.lsv.fr/~goubault/">Jean Goubault-Larrecq</a> and 
			<a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">Eric Goubault</a>.</p>
		<p>Email: jeremy[dot]dubut[at]aist[dot]go[dot]jp</p>
		<p> <a href="https://dblp.org/pers/hd/d/Dubut:J=eacute=r=eacute=my">dblp</a>, 
			<a href="https://researchmap.jp/dubut/?lang=english">research map</a>, 
			<a href="https://scholar.google.com/citations?user=k8NVQh8AAAAJ&hl=en">Google scholar</a>, 
			<a href="https://orcid.org/0000-0002-2640-3065">orcid</a></p>
	
	<!-- <h2><?php echo date('Y/m/d') ?></h2> -->
	<h2>Upcoming events and news</h2>
		<ul>
			<li> I will not be able to come but please consider attending the <a href="https://ncm29.math.aau.dk">29th Nordic Congress of Mathematicians</a>, 
					and particularly GETCO, in Aalborg in July.
			</li>
			<li>Our paper Formalizing Results on Directed Sets in Isabelle/HOL (with Akihisa Yamada) 
				has been accepted for presentation at <a href="https://mizar.uwb.edu.pl/ITP2023/">ITP</a> 
				in Bialystok (Poland) in August (see [<a href="#itp23">16</a>]).
			</li>
			<li> My paper Aczel-Mendler Bisimulations in a Regular Category has been accepted for 
				presentation at <a href="https://coalg.org/calco-mfps-2023/">CALCO</a>, in Bloomington, Indiana, in June
				(see [<a href="#calco23">17</a>]). 
			</li>
			<li> Our paper A Categorical Framework for Program Semantics and Semantic Abstraction 
				(with Shin-ya Katsumata and Xavier Rival) has been accepted for presentation at 
				<a href="https://coalg.org/calco-mfps-2023/">MFPS XXXIX</a> , in Bloomington, Indiana, in June
				(see [<a href="#mfps23">18</a>]).

			</li>
		</ul> 
	<h2>Research interests</h2>
		<ul>
			<li>categorical aspects of computer science</li>
			<li>(true) concurrency</li>
			<li>(directed) algebraic topology</li>
			<li>formal methods for CPS</li>
	...
	<h2 id="publis">Publications</h2>
		<h3>Journals</h3>
			<ol reversed type = "i">
				<li id="automatica23"> 
					...
					<a href="https://psasinee.github.io">S. Pruekprasert</a>, 
					J. Dubut, 
					<a href="http://group-mmm.org/~toru/">T. Takisaka</a>, 
					<a href="http://group-mmm.org/~eberhart/">C. Eberhart</a>, and 
					<a href="http://www.ahmet.ac">A. Cetinkaya</a><br>
					<b><font color="#2E64FE">Moment Propagation Through Carleman Linearization with Application to Probabilistic Safety Analysis.</font></b> 
					(pdf and code to be made available soon)<br>
					<font color="#FF0000">To appear in Automatica.</font><br>
					Extended version of [<a href="#ifac20">11</a>].
					</button>
				...
				<li id = "iv22">
					<button type="button" class="collapsible">
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a>, 
					<a href="http://group-mmm.org/~eberhart/">C. Eberhart</a>, 
					<a href="https://github.com/jameshaydon">J. Haydon</a>, 
					J. Dubut, 
					<a href="https://www.wpi.edu/people/faculty/rbohrer">R. Bohrer</a>, 
					<a href="https://researchmap.jp/tsutomu.kobayashi?lang=en">T. Kobayashi</a>, 
					<a href="https://psasinee.github.io">S. Pruekprasert</a>, 
					<a href="http://group-mmm.org/~xiaoyi/">X. Zhang</a>, 
					E. A. Pallas, 
					<a href="https://akihisayamada.github.io">A. Yamada</a>, 
					<a href="https://www.fos.kuis.kyoto-u.ac.jp/~ksuenaga/">K. Suenaga</a>, 
					<a href="http://research.nii.ac.jp/~f-ishikawa/en/">F. Ishikawa</a>, 
					K. Kamijo, 
					Y. Shinya, and 
					T. Suetomi<br>
					<b><font color="#2E64FE">Goal-Aware RSS for Complex Scenarios Via Program Logic</font></b> 
					(<a href="https://arxiv.org/pdf/2207.02387.pdf">pdf</a>, 
					<a href="https://www.nii.ac.jp/news/release/2022/0707.html">NII news release</a>, 
					<a href="https://www.jst.go.jp/pr/announce/20220707-3/index.html">JST news release</a>, 
					<a href="https://youtu.be/du2AkljAe88">YouTube video</a>)<br>
					<font color="FF0000">IEEE Transactions on Intelligent Vehicles, 2022</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					<button type="button" class="collapsible">
					J. Dubut and 
					<a href="https://akihisayamada.github.io">A. Yamada</a><br>
					<b><font color="#2E64FE">Fixed Point Theorems for Non-Transitive Relations.</font></b> 
					(<a href="https://arxiv.org/abs/2009.13065">pdf</a>, 
					<a href="https://www.isa-afp.org/entries/Complete_Non_Orders.html">AFP entry</a>)<br>
					<font color="#FF0000">Logical Methods in Computer Science 18(1), pages 30:1-30:24, 2022.</font><br>
					Extended version of [<a href="#itp19">7</a>].
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li>
					<button type="button" class="collapsible">
					<a href="https://davidsprunger.com">D. Sprunger</a>, 
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, 
					J. Dubut, and 
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a><br>
					<b><font color="#2E64FE">Fibrational Bisimulations and Quantitative Reasoning: Extended Version.</font></b> 
					(<a href="papers/jlc21.pdf">pdf</a>)<br>
					<font color="#FF0000">Journal of Logic and Computation 31(6), pages 1526-1559, 2021.</font><br>
					Extended version of [<a href="#cmcs18">4</a>].
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					<button type="button" class="collapsible">
					<a href="https://thorsten-wissmann.de">T. Wißmann</a>, 
					<a href="https://www8.cs.fau.de/milius">S. Milius</a>, 
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, and 
					J. Dubut<br>
					<b><font color="#2E64FE">A Coalgebraic View on Reachability.</font></b> 
					(<a href="https://arxiv.org/pdf/1901.10717.pdf">pdf</a>)<br>
					<font color="#FF0000">Commentationes Mathematicae Universitatis Carolinae 60(4), pages 605-638, 2019.</font><br>
					Special issue dedicated to Věra Trnková.
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li>
					<button type="button" class="collapsible">
					J. Dubut, 
					<a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a>, and 
					<a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a><br>
					<b><font color="#2E64FE">Directed homology theories and Eilenberg-Steenrod axioms.</font></b> 
					(<a href="papers/apcs17.pdf">pdf</a>)<br>
					<font color="#FF0000">Applied Categorical Structures 25(5), pages 775-807, 2017.</font><br>
					Extended version of [<a href="#icalp15">1</a>].
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
		...
		<h3>Conferences</h3>
			<ol reversed type = "1">
				<li id = "mfps23"> 
					<button type="button" class="collapsible">
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, 
					<a href="https://www.di.ens.fr/~rival/">X. Rival</a>, 
					and J. Dubut<br>
					<b><font color="#2E64FE">A Categorical Framework for Program Semantics and Semantic Abstraction.</font></b> 
					(pdf soon)<br>
					<font color="#FF0000">In MFPS'23.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "calco23"> 
					<button type="button" class="collapsible">
					J. Dubut<br>
					<b><font color="#2E64FE">Aczel-Mendler Bisimulations in a Regular Category.</font></b> 
					(<a href="https://arxiv.org/pdf/2303.04442.pdf">pdf (to be updated)</a>)<br>
					<font color="#FF0000">In CALCO'23.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "itp23"> 
					<button type="button" class="collapsible">
					<a href="https://akihisayamada.github.io">A. Yamada</a> and 
					J. Dubut<br>
					<b><font color="#2E64FE">Formalizing Results on Directed Sets in Isabelle/HOL.</font></b> 
					(<a href="papers/itp23.pdf">pdf</a>, 
					AFP entry soon)<br>
					<font color="#FF0000">In ITP'23.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "fossacs23">
					<button type="button" class="collapsible">
					J. Dubut and 
					<a href="https://thorsten-wissmann.de">T. Wißmann</a><br>
					<b><font color="#2E64FE">Weighted and Branching Bisimilarities from Generalized Open Maps</font></b> 
					(<a href="https://arxiv.org/pdf/2301.07004.pdf">pdf</a>,
					<a href="presentations/fossacs23.pdf">slides</a>)<br>
					<font color="FF0000">In FoSSaCS'23</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "cdc22">
					...
					<a href="https://github.com/jameshaydon">J. Haydon</a>, 
					J. Dubut, 
					<a href="http://www.ahmet.ac">A. Cetinkaya</a>, and 
					<a href="https://psasinee.github.io">S. Pruekprasert</a><br>
					<b><font color="#2E64FE">Logic for Timed Agent Network Topologies.</font></b> 
					(<a href="https://group-mmm.org/~eberhart/research/mu-tgl.pdf">pdf</a>)<br>
					<font color="#FF0000">In CDC'22, 2022.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
 				...
 				<li> 
					...
					<a href="http://group-mmm.org/~eberhart/">C. Eberhart</a>, and 
					J. Dubut<br>
					<b><font color="#2E64FE">Fast Synthesis for Symbolic Self-triggered Control under Right-recursive LTL Specifications.</font></b> 
					(<a href="https://arxiv.org/pdf/2103.16122.pdf">pdf</a>)<br>
					<font color="#FF0000">	In CDC'21, 2021.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "icarcv20"> 
					...
					<a href="http://group-mmm.org/~eberhart/">C. Eberhart</a>, and 
					J. Dubut<br>
					<b><font color="#2E64FE">Symbolic Self-triggered Control of Continuous-time Non-deterministic Systems without Stability Assumptions for 2-LTL Specifications.</font></b> 
					(<a href="https://arxiv.org/pdf/2010.11663.pdf">pdf</a>)<br>
					<font color="#FF0000">In ICARCV'20, 2020.</font> <a href="papers/icarcv-award20.pdf">Best paper award finalist!</a>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "ifac20"> 
					...
					<a href="http://www.ahmet.ac">A. Cetinkaya</a>, and 
					J. Dubut<br>
					<b><font color="#2E64FE">Moment Propagation of Discrete-Time Stochastic Polynomial Systems using Truncated Carleman Linearization.</font></b> 
					(<a href="https://arxiv.org/pdf/1911.12683.pdf">pdf</a>)<br>
					<font color="#FF0000">In IFAC'20, 2020.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					<button type="button" class="collapsible">
					J. Dubut<br>
					<b><font color="#2E64FE">Bisimilarity of diagrams.</font></b> 
					(<a href="https://arxiv.org/pdf/1804.10886.pdf">pdf</a>, 
					<a href="presentations/ramics20.pdf">slides</a>, 
					<a href="https://www.youtube.com/watch?v=evgYDpn3E64">youtube video</a>)<br>
					<font color="#FF0000">In RAMiCS'20, LNCS 12062, pages 65-81, Springer, 2020.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					<button type="button" class="collapsible">
					<a href="http://www.lsv.fr/~kolcak/">J. Kolčák</a>, 
					J. Dubut, 
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a>, 
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, 
					<a href="https://davidsprunger.com">D. Sprunger</a>, and 
					<a href="https://akihisayamada.github.io">A. Yamada</a><br>
					<b><font color="#2E64FE">Relational Differential Dynamic Logic.</font></b> 
					(<a href="https://arxiv.org/pdf/1903.00153.pdf">pdf</a>, 
					<a href="http://group-mmm.org/rddl_tacas_2020/">code</a>)<br>
					<font color="#FF0000">	In TACAS'20, LNCS 12078, pages 191-208, Springer, 2020.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					...
					<a href="http://group-mmm.org/~xiaoyi/">X. Zhang</a>, 
					J. Dubut, 
					<a href="http://group-mmm.org/~chao_h/">C. Huang</a>, and 
					<a href="https://researchmap.jp/m.kishida/">M. Kishida</a><br>
					<b><font color="#2E64FE">Decision Making for Autonomous Vehicles at Unsignalized Intersection in Presence of Malicious Vehicles.</font></b> 
					(<a href="https://arxiv.org/pdf/1904.10158.pdf">pdf</a>)<br>
					<font color="#FF0000">	In ITSC'19, IEEE, 2019.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "itp19"> 
					...
					<a href="https://akihisayamada.github.io">A. Yamada</a> and 
					J. Dubut<br>
					<b><font color="#2E64FE">Complete Non-Orders and Fixed Points.</font></b> 
					(<a href="papers/itp19.pdf">pdf</a>, 
					<a href="https://www.isa-afp.org/release/afp-Complete_Non_Orders-2020-04-18.tar.gz">AFP entry (depreciated)</a>, 
					<a href="presentations/akihisaitp19.pdf">slides by Akihisa</a>)<br>
					<font color="#FF0000">	In ITP'19, Leibniz International Proceedings in Informatics 141, pages 30:1-30:16. Leibniz-Zentrum für Informatik, 2019.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					<button type="button" class="collapsible">
					J. Dubut<br>
					<b><font color="#2E64FE">Trees in partial Higher Dimensional Automata.</font></b> 
					(<a href="https://arxiv.org/pdf/1804.10894.pdf">pdf</a>, 
					<a href="presentations/fossacs19.pdf">slides</a>)<br>
					<font color="#FF0000">	In FoSSaCS'19, LNCS 11425, pages 224-241, Springer, 2019.</font> 
					<a href="https://www.etaps.org/2019/best-papers">EATCS best paper award!</a>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					...
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, and 
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a><br>
					<b><font color="#2E64FE">Path category for free - Open morphisms from coalgebras with non-deterministic branching.</font></b> 
					(<a href="https://arxiv.org/pdf/1811.12294.pdf">pdf</a>, 
					<a href="presentations/thorstenfossacs19.pdf">slides by Thorsten</a>)<br>
					<font color="#FF0000">In FoSSaCS'19, LNCS 11425, pages 523-540, Springer, 2019.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "cmcs18">
					...
					J. Dubut, and 
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a><br>
					<b><font color="#2E64FE">Fibrational Bisimulations and Quantitative Reasoning.</font></b> 
					(<a href="papers/cmcs18.pdf">pdf</a>, 
					<a href="https://s3-us-west-2.amazonaws.com/terrastatic/media/cmcs2018slides.pdf">slides by David</a>)<br>
					<font color="#FF0000">In CMCS'18, LNCS 11202, pages 190-213, Springer, 2018.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
							Bisimulation and bisimilarity are fundamental notions in comparing state-based systems. 
				...
				<li>
					...
					<a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a>, and 
					<a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a><br>
					<b><font color="#2E64FE">The Directed Homotopy Hypothesis.</font></b> 
					(<a href="papers/csl16.pdf">pdf</a>, 
					<a href="presentations/csl16.pdf">slides</a>)<br>
					<font color="#FF0000">In CSL'16, Leibniz International Proceedings in Informatics 62, pages 9:1-9:16. Leibniz-Zentrum für Informatik, 2016.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li>
					...
					<a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a>, and 
					<a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a><br>
					<b><font color="#2E64FE">Bisimulations and unfolding in P-accessible categorical models.</font></b> 
					(<a href="papers/concur16.pdf">pdf</a>, 
					<a href="presentations/concur16.pdf">slides</a>)<br>
					<font color="#FF0000">In CONCUR'16, Leibniz International Proceedings in Informatics 59, pages 25:1-25:14. Leibniz-Zentrum für Informatik, 2016.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li id = "icalp15">
					...
					<a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a>, and 
					<a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a><br>
					<b><font color="#2E64FE">Natural Homology.</font></b> 
					(<a href="papers/icalp15.pdf">pdf</a>, 
					<a href="presentations/icalp15.pdf">slides</a>)<br>
					<font color="#FF0000">In ICALP'15, LNCS 9135, pages 171-183. Springer, 2015.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
		...
		<h3>Preprints</h3>
			<ul>
				<!--<li> 
					<button type="button" class="collapsible">
					J. Dubut<br>
					<b><font color="#2E64FE">Aczel-Mendler Bisimulations in a Regular Category.</font></b> (<a href="https://arxiv.org/pdf/2303.04442.pdf">pdf</a>)<br>
					<font color="#FF0000"><a href="https://arxiv.org/abs/2303.04442">arXiv:2303.04442</a>.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
							Aczel-Mendler bisimulations are a coalgebraic extension of a variety of 
				...
				<!--<li> 
					<button type="button" class="collapsible">
					<a href="https://psasinee.github.io">S. Pruekprasert</a>, J. Dubut, <a href="http://group-mmm.org/~toru/">T. Takisaka</a>, <a href="http://group-mmm.org/~eberhart/">C. Eberhart</a>, and <a href="http://www.ahmet.ac">A. Cetinkaya</a><br>
					<b><font color="#2E64FE">Moment Propagation Through Carleman Linearization with Application to Probabilistic Safety Analysis.</font></b> (<a href="https://arxiv.org/pdf/2201.08648.pdf">pdf</a>)<br>
					<font color="#FF0000"><a href="https://arxiv.org/abs/2201.08648">arXiv:2201.08648</a>.</font><br>
					Extended version of [<a href="#ifac20">11</a>].
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					...
					<a href="http://group-mmm.org/~chao_h/">C. Huang</a>, and 
					<a href="https://researchmap.jp/m.kishida/">M. Kishida</a><br>
					<b><font color="#2E64FE">A Game Theoretic Approach to Decision Making for Multiple Vehicles at Roundabout.</font></b> 
					(<a href="https://arxiv.org/pdf/1904.06224.pdf">pdf</a>)<br>
					<font color="#FF0000">	<a href="https://arxiv.org/abs/1904.06224">arXiv:1904.06224</a>.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li> 
					...
					J. Dubut, 
					<a href="http://group-mmm.org/~s-katsumata/index-e.html">S. Katsumata</a>, 
					<a href="http://group-mmm.org/~ichiro/">I. Hasuo</a>, and 
					<a href="https://davidsprunger.com">D. Sprunger</a><br>
					<b><font color="#2E64FE">Quantitative bisimulations using coreflections and open morphisms.</font></b> 
					(<a href="https://arxiv.org/pdf/1809.09278.pdf">pdf</a>)<br>
					<font color="#FF0000">	<a href="https://arxiv.org/abs/1809.09278">arXiv:1809.09278</a>.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
		...
		<h3>Theses</h3>
			<ul>
				<li>
					<button type="button" class="collapsible">
					<b><font color="#2E64FE">Directed homotopy and homology theories for geometric models of true concurrency.</font></b> (<a href="papers/phd17.pdf">pdf</a>, <a href="presentations/phd17.pdf">slides</a>)<br>
					<font color="#FF0000">PhD under the supervision of <a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a> and <a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a> at Laboratoire Spécification et Vérification, ENS Paris-Saclay, Cachan, France, 2017.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
							...
							This brings many complications and the theory must be done again.<br>
				...
				<li>
					<button type="button" class="collapsible">
					<b><font color="#2E64FE">Homologie Dirigée.</font></b> (<a href="papers/master14.pdf">pdf</a>, in French)<br>
					<font color="#FF0000">M2 internship under the supervision of <a href="http://www.lix.polytechnique.fr/Labo/Eric.Goubault/">E. Goubault</a> and <a href="http://www.lsv.fr/~goubault/">J. Goubault-Larrecq</a> at Ecole Polytechnique, Palaiseau, France, 2014.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li>
					<button type="button" class="collapsible">
					<b><font color="#2E64FE">Application de la topologie algébrique en informatique théorique.</font></b> (<a href="papers/master12.pdf">pdf</a>, in French)<br>
					<font color="#FF0000">M1 internship under the supervision of <a href="https://hessbellwald-lab.epfl.ch/HessBellwald">K. Hess Bellwald</a> at Ecole Polytechnique Fédérale de Lausanne, Switzerland, 2012.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
				...
				<li>
					<button type="button" class="collapsible">
					<b><font color="#2E64FE">Décidabilité de la déduction et de l’équivalence statique pour le chiffrement homomorphique.</font></b> (<a href="papers/cs-bachelor11.pdf">pdf</a>, in French)<br>
					<font color="#FF0000">L3 internship under the supervision of <a href="https://members.loria.fr/VCortier/">V. Cortier</a> at Laboratoire Lorrain de Recherche en Informatique et ses Applications, Nancy, France, 2011.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
							to be written
				...
				<li>
					<button type="button" class="collapsible">
					<b><font color="#2E64FE">Le modèle de Cucker-Smale: Émergence et formation de structures et de motifs dans les groupes (troupeaux, bancs, colonies, nuées)</font></b> (<a href="papers/maths-bachelor11.pdf">pdf</a>, in French)<br>
					<font color="#FF0000">L3 internship with C. Eberhart under the supervision of <a href="https://sites.google.com/site/fredppascal/">F. Pascal</a> at Centre de Mathématiques et Leurs Applications, ENS Cachan, France, 2011.</font>
					</button>
					<div class="contentCollapsible">
						<p><b><u>Abstract:</u></b><br>
						<br>
	...
	<h2 id="talks">Some presentations</h2>
			<ul>
				<li>
 					<a href="presentations/trs21.pdf">slides</a> for the <a href='https://akihisayamada.github.io/trs54/'>54th TRS meeting</a>
 				</li>
				<li>
					<a href="presentations/kyoto19.pdf">slides</a> for a seminar at Igarashi lab, Kyoto University
				</li>
				<li>
					<a href="presentations/dhs19.pdf">slides</a> for <a href="http://dhs.gforge.inria.fr">DHS 2019</a>
				</li>
				<li>
					<a href="presentations/hscc19.pdf">poster</a> (made by <a href="http://www.lsv.fr/~kolcak/">Juraj</a>) for the ERATO MMSD Symposium on Automated Driving Safety
				</li>
				<li>
					<a href="presentations/pps19.pdf">slides</a> for the PPS seminar, Paris 7
				</li>
				<li>
					<a href="presentations/ymc19_talk.pdf">slides</a> and <a href="presentations/ymc19_poster.pdf">poster</a> for the <a href="https://www.jst.go.jp/kisoken/crest/math-challenge2019/">Young Mathematicians' Challenge</a> in Tokyo
				</li>
				<li>
					<a href="presentations/jfr18.pdf">slides</a> (in French) for a flash talk at the <a href="http://www.sciencescope.org/jfr-2018-journee-francophone-de-la-recherche-2018/">Journée Francophone de la Recherche</a> in Tokyo
				</li>
				<li>
					<a href="presentations/dhs18.pdf">slides</a> for <a href="http://dhs.gforge.inria.fr">DHS 2018</a>
				</li>
				<li>
					<a href="presentations/swinterfesta17.pdf">slides</a> and <a href="presentations/pwinterfesta17.pdf">poster</a> for NII's Winter Festa
				</li>
				<li>
					<a href="presentations/shonan17.pdf">slides</a> for the Shonan meeting on Enhanced coinduction
				</li>
				<li>
					<a href="presentations/yrconcur17.pdf">slides</a> for Young Researcher CONCUR17
				</li>
				<li>
					<a href="presentations/acat17.pdf">slides</a> and <a href="https://www.youtube.com/watch?v=catsf-UFzfo&index=5&list=PLul8LCT3AJqTxsduEoCm4Rj_Fk0oSySSx">YouTube video</a> for the conference of the program Applied and Computational Algebraic Topology at Hausdorff Research Institute for Mathematics
				</li>
				<li>
					<a href="presentations/stic16.pdf">slides</a> for the Prix Doctorants ED STIC 2016 ceremony at the journée de rentrée at ENSTA ParisTech
				</li>
				<li>
					<a href="presentations/accapt16.pdf">slides</a> for ACCAPT16
				</li>
				<li>
					<a href="presentations/gdrim16.pdf">poster</a> for the Journées nationales 2016 of GdR IM
				</li>
				<li>
					<a href="presentations/hcr15.pdf">slides</a> for HCR
				</li>
				<li>
					<a href="presentations/getco15.pdf">poster</a> for GETCO15
				</li>
			</ul>
		<h2 id="teachings">Teachings</h2>
			<h3>SOKENDAI (2019)</h3>
				I did a guest lecture for the <a href="https://docs.google.com/document/d/1DHGfk5DELDLwl1l3j0Zzyu3QxECdND082mTxFPAZ5Bc/edit#heading=h.3a1kb1gwi0ea">Formal Methods for Cyber-Physical Systems course</a> for SOKENDAI students on Deductive verification of hybrid systems<br>
				<a href="teachings/sokendai19/slides.pdf">slides</a>, <a href="teachings/sokendai19/Bouncing ball.kyx">KeYmaera model</a>, <a href="teachings/sokendai19/Bouncing ball_ Proof 1.kya">Keymaera proof</a>, <a href="teachings/sokendai19/assignment.pdf">home assignment</a>
			<h3>ENS Paris-Saclay (2014-2017)</h3>
			...
			<h4>Rewriting systems</h4>
				Those sessions were for students in first year of master, and were made in collaboration with Hubert Comon and Frédéric Blanqui.<br>
				<a href="teachings/archive_trs.zip">archive of exercises</a>, <a href="teachings/archive_kbcv.zip">archive of rewriting systems for kbcv</a>.
			<h4>Tree automata</h4>
				Those sessions were for students in first year of master, and were made in collaboration with Hubert Comon and Sylvain Schmitz.<br>
				<a href="teachings/archive_tata.zip">archive of exercises</a>.
			<h4>Logic</h4>
				Those sessions were undergraduates, and were made in collaboration with Lucca Hirschi, Hubert Comon, Gilles Dowek, and Étienne Lozes.<br>
				<a href="teachings/archive_logic.zip">archive of exercises</a>.
